...
<html lang="pt-br">
	<head>
		...
		<link rel="stylesheet" href="css/clientsignup.css">
		...
		<title>Solicitar Acesso - Cliente</title>
	</head>
	<body>
		<div id="background">
			...
			<svg class="cpf-box">
				<rect fill="rgba(255,255,255,1)" stroke="rgba(240,56,97,1)" stroke-width="3px" stroke-linejoin="round" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="cpf-box" rx="30" ry="30" x="0" y="0" width="676" height="60">
				</rect>
			</svg>
			...
			<form action="inserir-cliente.php" method="POST">
				<div id="signup-txt">
					<span>Solicitar Acesso - Cliente</span>
				</div>
				<div class="card-nome">
				...
				<div class="card-telefone">
					<input type="text" name="telefone" placeholder="Celular" maxlength="11">
				</div>
				<div class="card-cpf">
			...
			<div id="backtxt">
				<a class="fontevoltartxt" href="login-cliente.php">Voltar</a>
			</div>
        </div>
        <?php				
